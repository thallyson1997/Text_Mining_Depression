---
title: "METODO 3 - Redução parcial da Classe Marjoritária (2 * n0 = n1)."
...
resultado <- rodar_pipeline(
  TREINO,
  TESTE,
  "C:/Users/usuario/OneDrive/Documentos/Text_Mining_Reddit_Depression_Post/Resultado/METODO_3"
)
```